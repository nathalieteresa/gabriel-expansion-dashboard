...
def generate_executive_pdf():
    ...
    score_chart.update_traces(texttemplate="%{text:.1f}", textposition="outside")
    ...
    score_img = BytesIO(score_chart.to_image(format="png"))
    elements.append(Image(score_img, width=500, height=285))
    elements.append(Spacer(1, 18))
    ...
    financial_img = BytesIO(financial_chart.to_image(format="png"))
    elements.append(Image(financial_img, width=500, height=285))
    elements.append(Spacer(1, 18))
    ...
    ranking_chart.update_traces(texttemplate="%{text:.1f}", textposition="outside")
    ...
    ranking_img = BytesIO(ranking_chart.to_image(format="png"))
    elements.append(Image(ranking_img, width=500, height=285))
    elements.append(Spacer(1, 18))
